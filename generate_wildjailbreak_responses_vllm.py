...
def main(args):
    ...
    dataset = load_dataset("allenai/wildjailbreak", "train", delimiter="\t", keep_default_na=False, token=access_token)
    ...
    prompts = dataset["vanilla"]
    outputs = llm.generate(dataset["vanilla"], sampling_params)
    ...
    output_folder = "outputs/wildjailbreak"
